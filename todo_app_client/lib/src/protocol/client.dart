...
import 'package:todo_app_client/src/protocol/todo.dart' as _i3;
...
class EndpointTodo extends _i1.EndpointRef {
  ...
  _i2.Future<int> createTodo(_i3.Todo todo) => caller.callServerEndpoint<int>(
        'todo',
        'createTodo',
        {'todo': todo},
      );

  _i2.Future<List<_i3.Todo>> getTodoList({String? keyword}) =>
